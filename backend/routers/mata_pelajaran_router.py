...
def update_mata_pelajaran(mapel_id: int, data: MataPelajaranUpdate, db: Session = Depends(get_db)):
...
def delete_mata_pelajaran(mapel_id: int, db: Session = Depends(get_db)):
